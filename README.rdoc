...
* Go to [http://oscar.go.com/nominees](http://oscar.go.com/nominees) and copy xhr response from nominees request.
* `ruby script/parser.rb`
...
* `heroku pg:backups capture` (create current backup, but it's automated anyway)
